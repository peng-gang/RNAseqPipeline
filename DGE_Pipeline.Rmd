...
twoGroupCompare(Feature_Counts = cts,Sample_Info = sampleInfo, Samples_Column_Name = "ID", Gene_Info = geneInfo, Genes_Column_Name = "Geneid", Variable_Of_Interest = "group", Groups_Selected = c("KO_2","KO_4"),Folder_name = "KO_2VsKO_4", pvalue_Cutoff = 0.05,log2Fold_Cutoff = log2(1.5))
